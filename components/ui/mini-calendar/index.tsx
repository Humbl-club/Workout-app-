...
export const MiniCalendar = ({
  ...
  return (
    <MiniCalendarContext.Provider value={contextValue}>
      <div
        className={cn(
          'flex items-center gap-2 rounded-lg border border-[var(--border)] bg-[var(--surface)] p-2',
          className
        )}
        {...props}
      >
  ...
  return (
    <Button
      className={cn(
        ...
        isTodayDate && !isSelected && 'bg-[var(--accent-light)]',
    ...
    >
      <span
        className={cn(
          'font-medium text-[10px] text-[var(--text-tertiary)]',
