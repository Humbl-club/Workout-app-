...
export const LogoIcon = ({ className = '', isLoading = false, ...props }: React.HTMLAttributes<HTMLDivElement> & { className?: string; isLoading?: boolean }) => (
    <div className={`font-black leading-none logo-spacing ${className} ${isLoading ? 'animate-pulse-logo' : ''}`} {...props}>
        <span>RE</span>
        <span className="text-red-500">BLD</span>
    </div>
);
...
export const ChatBubbleIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.28c-.442.033-.87.22-1.206.505-1.157.994-2.618 1.6-4.192 1.6-3.473 0-6.55-2.5-7.14-5.833-.102-.5-.157-1.008-.157-1.524V10.608c0-1.136.847-2.1 1.98-2.193l3.722-.28c.442-.033.87-.22 1.206-.505 1.157-.994 2.618 1.6 4.192 1.6 1.45 0 2.802.502 3.92 1.348z" />
    </svg>
);

export const BrainCircuitIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4-2.245 4.5 4.5 0 118.4-2.472A6.75 6.75 0 109.53 16.122z" />
    </svg>
);
...
export const LightBulbIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a3 3 0 006 0 3 3 0 00-6 0zm0 0I21 12.75H3M12 21a9 9 0 110-18 9 9 0 010 18z" />
    </svg>
);
...
export const BookCheckIcon = (props: React.SVGProps<SVGSVGElement>) => (
     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const Bars2Icon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const PencilSquareIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 19.82a2.25 2.25 0 01-1.272.772l-4.5 1.25a.75.75 0 01-.97-1.131l1.25-4.5a2.25 2.25 0 01.772-1.272l11.059-11.059z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 12.75l-4.5-4.5" />
    </svg>
);
...
export const TrophyIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 15.75a3.75 3.75 0 00-3.75 3.75h7.5A3.75 3.75 0 0012 15.75z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 12.75V15m6-7.5v-1.5a1.5 1.5 0 00-1.5-1.5h-1.5m-3 0h-1.5a1.5 1.5 0 00-1.5 1.5V6m6 0v1.5m0-1.5h-1.5m-3 0h-1.5" />
    </svg>
);
...
export const SpeedometerIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 21v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21m0 0h4.5V3.545M12.75 21h7.5V10.75M2.25 21h1.5m18 0h-18M2.25 9l4.5-1.636M18.75 3l-1.5.545m0 6.205l3 1m-3-1l-3 1m0-1l-3-1m3 1v5.5" />
    </svg>
);
...
export const SunIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.25m6.364 1.636l-1.591 1.591M21 12h-2.25m-1.636 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z" />
    </svg>
);
